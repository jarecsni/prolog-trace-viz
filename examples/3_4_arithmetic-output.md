...
│    [1.2] N is N1 + 1 → _1604 is N1 + 1
│  
│  ┌─ Step 2 [Goal 1.1]: llength([2,3],N1)
│  │  Clause: llength([_|T], N) [line 23]
│  │  Unifications:
│  │    _ = 2
│  │    T = [3]
...
│  │    [2.2] N is N1 + 1 → _1534 is N1 + 1
│  │  
│  │  ┌─ Step 3 [Goal 2.1]: llength([3],N1)
│  │  │  Clause: llength([_|T], N) [line 23]
│  │  │  Unifications:
│  │  │    _ = 3
│  │  │    T = []
...
│  │  │    [3.2] N is N1 + 1 → _1476 is N1 + 1
│  │  │  
│  │  │  ┌─ Step 4 [Goal 3.1]: llength([],N1)
│  │  │  │  Fact: llength([], 0) [line 22]
│  │  │  │  => N1 = 0
│  │  │  └─
│  │  │  ┌─ Step 5 [Goal 3.2]: N is N1 + 1 → _1304 is 0+1
│  │  │  │  where N1 = 0 (from Step 4)
│  │  │  │  => ? = 1 is 0+1
│  │  │  └─
│  │  │  => N1 = 1
│  │  └─
│  │  ┌─ Step 6 [Goal 2.2]: N is N1 + 1 → _1056 is 1+1
│  │  │  where N1 = 1 (from Step 3)
│  │  │  => ? = 2 is 1+1
│  │  └─
│  │  => N1 = 2
│  └─
│  ┌─ Step 7 [Goal 1.2]: N is N1 + 1 → _778 is 2+1
